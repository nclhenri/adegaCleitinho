...
<div class="novoCliente">
    <a class="icon-link icon-link-hover" style="--bs-icon-link-transform: translate3d(0, -.125rem, 0);" href="index.php?p=produtos&w=cadastrar">
        ...
        <tbody>
            <?php foreach ($lista as $linha) : ?>
                <tr>
                    ...
                    <td>
                        <div>
                            <a class="icon-link icon-link-hover" style="--bs-icon-link-transform: translate3d(0, -.125rem, 0);" href="index.php?p=produtos&w=atualizar&id=<?php echo $linha['idProduto'] ?>">
                    ...
                    <td>
                        <div>
                            <a class="icon-link icon-link-hover" style="--bs-icon-link-transform: translate3d(0, -.125rem, 0);" href="index.php?p=produtos&w=desativar&id=<?php echo $linha['idProduto'] ?>">
