        ...
        <tbody>
            <?php foreach ($lista as $linha) : ?>
                <tr>
                    ...
                    <td><?php echo $linha['fotoFuncionario']; ?></td>

                    <td><?php echo $linha['statusFuncionario']; ?></td>


                    <td> <a class="icon-link icon-link-hover" style="--bs-icon-link-transform: translate3d(0, -.125rem, 0);" href="index.php?p=funcionarios&e=atualizar">
                    ...
                    <td> <a class="icon-link icon-link-hover" style="--bs-icon-link-transform: translate3d(0, -.125rem, 0);" href="index.php?p=funcionarios&e=desativar]">
